...
export const AccountCenter: React.FC<IconSvgProps> = ({ size = 24, width, height, ...props }) => {
  return (
    <svg height={size || height} viewBox="0 0 24 24" width={size || width} {...props}>
      ...
      />
      <path
        d="M8.9877 12.7407C8.20146 13.1624 6.14087 14.0223 7.39585 15.0983C8.00959 15.624 8.69208 16 9.55081 16H14.4495C15.3082 16 15.9913 15.624 16.6038 15.0983C17.8594 14.0223 15.7988 13.1618 15.0126 12.7407C14.0973 12.2555 13.0581 12 12.0001 12C10.9422 12 9.90297 12.2555 8.9877 12.7407Z"
        stroke="currentColor"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth="1.3"
